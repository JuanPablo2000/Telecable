...
$.extend( Buttons.prototype, {
	...
	_draw: function ( container, buttons )
	{
      ...
      if(buttons[i].inserter.innerText=="pdf"){
        buttons[i].inserter.innerText='<span><i class="fas fa-file-pdf fa-lg"></i> PDF</span>'
      }
	...
	_buildButton: function ( config, inCollection )
	{
		...
		var button = $('<'+tag+'/>')
			...
			.on( 'click.dtb', function (e) {
				...
				//console.log(dt.buttons.exportData( config.exportOptions ));
				//console.log(dt.buttons.exportInfo( config ));

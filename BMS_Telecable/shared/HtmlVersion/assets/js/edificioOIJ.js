...
require(["baja!", "jquery", "bootstrap", "momentsLocales", "scrollbar", "pcoded", "imageMaps", "mapLight"], function(baja, $, bootstrap, moment, scrollbar) {
    ...
    var r = new baja.BatchResolve(["station:|slot:/Services/AlarmService/AlarmasDatacenter",
        "station:|slot:/Services/AlarmService/AlarmasAzotea"
    ]);
    ...
    function update(property) {
        switch (property.getName()) {
            ...
            case "AlarmasDatacenter":
                (property.getOut().getValue()) ? $('#alarmDC_OIJ').addClass('iconAlarm') : $('#alarmDC_OIJ').removeClass('iconAlarm');
                break;
            case "AlarmasAzotea":
                (property.getOut().getValue())? $('#alarmAzotea_OIJ').addClass('iconAlarm') : $('#alarmAzotea_OIJ').removeClass('iconAlarm');
                break;
